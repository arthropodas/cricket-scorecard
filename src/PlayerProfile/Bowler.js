...
import { Andile, Hendricks, ImranTahir, Rabada, Ngidi, Shamsi } from './PlayerData';


class BowlerRsa extends Component {
    constructor(props) {
      super(props);
      this.state = {};
    }
